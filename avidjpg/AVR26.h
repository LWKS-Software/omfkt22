 ...
 *
 ************************************************************************/
/* compress "AVR26 capture" 	640x240x32		Q=15	100k/f	res#2252
 */
/* Size = 640 x 240 x 32; Q Factor = 15; 102400 Bytes/frame (target);
   Resource #2252 */


#define AVR26_NAME "AVR26"
