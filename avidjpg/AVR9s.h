 ...
 *
 ************************************************************************/
/* compress "AVR9s 24 bit capture full detail" 	720x248x32		Q=6	150k/f	res#2902
 */
/* Size = 720 x 248 x 32; Q Factor = 6; 153600 Bytes/frame (target);
   Resource #2902 */


#define AVR9s_NAME "AVR9s"
