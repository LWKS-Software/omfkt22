 ...
 *
 ************************************************************************/
/* compress "AVR6m 24 bit capture full detail" 	360x248x32		Q=9	40k/f	res#1052
 */
/* Size = 360 x 248 x 32; Q Factor = 9; 40960 Bytes/frame (target);
   Resource #1052 */


#define AVR6m_NAME "AVR6m"
