...
/* Put 4 chars together into a int  (that works as a char string)*/

#if !defined( CHAR4 )
#if PORT_BYTESEX_LITTLE_ENDIAN

#define CHAR4(ch0, ch1, ch2, ch3) (int ) \
   ( (omfUInt32)(omfUInt8)(ch0)        | ((omfUInt32)(omfUInt8)(ch1) << 8 ) |  \
    ((omfUInt32)(omfUInt8)(ch2) << 16) | ((omfUInt32)(omfUInt8)(ch3) << 24) )

#else  /* big endian version*/

#define CHAR4(ch0, ch1, ch2, ch3) (int ) \
   ( (omfUInt32)(omfUInt8)(ch3)        | ((omfUInt32)(omfUInt8)(ch2) << 8 ) |  \
    ((omfUInt32)(omfUInt8)(ch1) << 16) | ((omfUInt32)(omfUInt8)(ch0) << 24) )
