...
/* Pragmas*/
#if !defined( PORT_PRAGMAS_MSOFT )
#define PORT_PRAGMAS_MSOFT      0
#endif
#if !defined( PORT_PRAGMAS_BORLAND )
#define PORT_PRAGMAS_BORLAND    0
#endif
#if !defined( PORT_PRAGMAS_SYMANTEC )
#define PORT_PRAGMAS_SYMANTEC   0
#endif
#if !defined( PORT_PRAGMAS_SGI )
...
#if PORT_MEM_DOS16 || defined(_WIN32) || PORTKEY_OS_MACSYS
...
#else
#pragma error("**not using native 64 bit type***")
