...
static int  total_num_small = 0;	/* total # of small objects alloced */
static int  total_bytes_small = 0;	/* total bytes requested */
static int  cur_num_small = 0;		/* # currently alloced */
static int  max_num_small = 0;		/* max simultaneously alloced */

#ifdef NEED_ALLOC_MEDIUM
static int  total_num_medium = 0;	/* total # of medium objects alloced */
static int  total_bytes_medium = 0;	/* total bytes requested */
static int  cur_num_medium = 0;		/* # currently alloced */
static int  max_num_medium = 0;		/* max simultaneously alloced */
#endif

static int  total_num_sarray = 0;	/* total # of sarray objects alloced */
static int  total_bytes_sarray = 0;	/* total bytes requested */
static int  cur_num_sarray = 0;		/* # currently alloced */
static int  max_num_sarray = 0;		/* max simultaneously alloced */

static int  total_num_barray = 0;	/* total # of barray objects alloced */
static int  total_bytes_barray = 0;	/* total bytes requested */
static int  cur_num_barray = 0;		/* # currently alloced */
static int  max_num_barray = 0;		/* max simultaneously alloced */
...
struct big_barray_control {
	int  rows_in_array;	/* total virtual array height */
	int  blocksperrow;	/* width of array (and of memory buffer) */
	int  unitheight;	/* # of rows accessed by access_big_barray() */
...
request_big_barray (int  blocksperrow, int  numrows, int  unitheight)
...
{
  int  bytesperrow, file_offset, byte_count, rows, i;
...
METHODDEF JBLOCKARRAY
access_big_barray (big_barray_ptr ptr, int  start_row, boolean writable)
...
jselmemmgr (external_methods_ptr emethods)
{
  ...
  { char * memenv;
    ...
    if ((memenv = getenv("JPEGMEM")) != NULL) {
      ...
      if (sscanf(memenv, "%d%c", &lval, &ch) > 0) {
	if (ch == 'm' || ch == 'M')
	  lval *= 1000L;
