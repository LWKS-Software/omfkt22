...
#define PROTO
#else
#if PORT_LANG_CPLUSPLUS		/* So do C++ compilers */
#define PROTO
#endif
#endif
...
#endif
#endif
#if PORT_SYS_MAC /* it's needed for Macintosh too */
#define TWO_FILE_COMMANDLINE
#endif
...
#ifdef INLINE			/* default is to define it as empty */
#undef INLINE			/* Override the definition in  portmacs.h */
#endif
 ...
 * or "int " not 32 bits.  We don't care whether "int" is 16 or 32 bits,
