...
#define OM_REG_ERR(file,ecode)	   omfRegErrDebug(file,(omfErr_t)ecode, __FILE__, (omfInt16)__LINE__)
#define OM_REREG_ERR(file,ecode)  omfReregErrDebug(file,(omfErr_t)ecode, __FILE__, (omfInt16)__LINE__)
#else 
#define OM_REG_ERR(file,ecode)
#define OM_REREG_ERR(file,ecode)
#endif
...
#define RAISE(a)		{ zzOmfEcode = (a); \
							OM_REG_ERR(zzOmfFile, zzOmfEcode); goto zzOmfCleanup;\
						}
...
#define XEXCEPT			goto zzOmfExit; \
						zzOmfCleanup:
#define XEND			if(zzOmfPropagate) { OM_REREG_ERR(zzOmfFile, zzOmfEcode);\
										   return(zzOmfEcode); } } zzOmfExit:
#define XEND_VOID		if(zzOmfPropagate) { OM_REREG_ERR(zzOmfFile, zzOmfEcode);\
											   return; } } zzOmfExit:
#define XEND_SPECIAL(a)	if(zzOmfPropagate) { OM_REREG_ERR(zzOmfFile, zzOmfEcode);\
											   return(a); } } zzOmfExit:
