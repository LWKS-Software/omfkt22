 ...
 *---------------------------------------------------------------------------*
 ...
 CMSize CMReadValueData(CMValue value, CMPtr buffer, CMCount offset, CMSize32 maxSize,
                        CMType *type);
 void CMWriteValueData(CMValue value, CMPtr buffer, CMCount offset, CMSize32 size);
...
typedef CMSize32 (*TcmReadValueData)(CMValue value, CMPtr buffer, CMCount offset, CMSize32 maxSize);
typedef void (*TcmWriteValueData)(CMValue value, CMPtr buffer, CMCount offset, CMSize32 size);
...
/* Note, these casts are not just placed here for the hell of it!  They are delibertly  */
...
#define CMDynReadValueData(v, b, x, m)    (*(TcmReadValueData)DYNEXTENSIONS(v)->dynValueVector.cmReadValueData.handler)((CMValue)(v), (CMPtr)(b), (x), (CMSize32)(m))
#define CMDynWriteValueData(v, b, x, n)   (*(TcmWriteValueData)DYNEXTENSIONS(v)->dynValueVector.cmWriteValueData.handler)((CMValue)(v), (CMPtr)(b), (x), (CMSize32)(n))
#define CMDynInsertValueData(v, b, x, n)  (*(TcmInsertValueData)DYNEXTENSIONS(v)->dynValueVector.cmInsertValueData.handler)((CMValue)(v), (CMPtr)(b), (x), (n))
#define CMDynDeleteValueData(v, x, n)     (*(TcmDeleteValueData)DYNEXTENSIONS(v)->dynValueVector.cmDeleteValueData.handler)((CMValue)(v), (x), (n))
...
CM_EXPORT CMValue cmGetDynHandlerAddress(CMValue value, DynamicValueVectorEntriesPtr vectorEntry,
...
CM_EXPORT unsigned int  cmVScanDataPacketGuts(struct TOCObject *type, char *metaData,
...
CM_EXPORT void cmDeleteAllDynamicValueLayers(struct TOCValueHdr *theValueHdr, Boolean freeValueHdr);
  /*
