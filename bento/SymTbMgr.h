...
CM_EXPORT void *cmEnterSymbol(const void *symbol, void **root, Boolean *dup,
...
CM_EXPORT void *cmLookupSymbol(const void *symbol, const void *root,
                               int (*compare)(const void *, const void *));
 /*
...
CM_EXPORT void cmForEachSymbol(const void *symbol, CMRefCon refCon,
...
CM_EXPORT void cmFreeAllSymbols(CMContainer container, void **root,
