...
#define CM_err_CantDelete6       129/* Cannot delete an object currently in use in container "^0"                         */
...
#define CM_err_CRSwap         	135 /*Invalid global name string read in container "^0" */
