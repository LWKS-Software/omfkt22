...
CM_EXPORT void *cmUseIOBuffer(struct Container *container, int  maxBufferSize, jmp_buf *ioEnv);
	/*
...
CM_EXPORT void cmReleaseIOBuffer(void *ioBuffer);
	/*
...
CM_EXPORT void cmFreeAllIOBuffers(struct Container *container);
	/*
...
CM_EXPORT void cmNewBufferedOutputData(void *ioBuffer, struct TOCValueHdr *theValueHdr);
	/*
...
CM_EXPORT void cmWriteBufferedData(void *ioBuffer, CMSize32 size, CM_ULONG data4);
	/*
...
CM_EXPORT void cmFlushOutputBuffer(void *ioBuffer);
	/*
...
CM_EXPORT void cmNewBufferedInputData(void *ioBuffer, struct TOCValueHdr *theValueHdr,
...
CM_EXPORT CM_ULONG cmReadBufferedData(void *ioBuffer, CMSize32 size);
	/*
...
CM_EXPORT CMCount cmBufferedIOftell(void *ioBuffer);
	/*
