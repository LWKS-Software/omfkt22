...
typedef int             CM_LONG;                  /* 4-byte objects                     */
typedef unsigned int    CM_ULONG;
...
typedef omfInt64  CMSize;                         /* sizes                              */
typedef omfInt64  CMCount;                        /* amounts or counts                  */
typedef CM_ULONG  CMSize32;
typedef CM_ULONG  CMCount32;

typedef CM_ULONG  CMObjectID;                     /* object ID's                        */

CM_CFUNCTIONS                                     /* see      cmapienv.h      about this*/
...
typedef CMType (CM_FIXEDARGS *GetUpdatingTargetType)(CMContainer theUpdatingContainer);
  ...
  /*
  This is the prototype definition for the basic IO handler setup function (refCon creator).
  */

typedef CMRefCon (CM_FIXEDARGS *CMRefConFunc)(CMSession,const char CM_PTR *,
												GetUpdatingTargetType, omfHdl_t);
...
#define kCMLittleEndian   0x0101U                 /* little-endian byte ordering        */
...
#define kCMAppendRaw	  0x0040U				  /* append container to a raw file     */
