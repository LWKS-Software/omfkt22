...
CM_EXPORT void cmAddObjToTouchedChain(struct Container *container, struct TOCObject *theObject);
  /*
...
CM_EXPORT void cmDeleteTouchedList(struct TOCObject *theObject);
  /*
...
CM_EXPORT Boolean cmTouchEditedValue(struct TOCValueHdr *theValueHdr);
  /*
...
CM_EXPORT Boolean cmTouchImmediateValue(struct TOCValueHdr *theValueHdr);
  /*
...
CM_EXPORT Boolean cmTouchBaseType(struct TOCValueHdr *theValueHdr);
  /*
...
CM_EXPORT Boolean cmTouchSetInfoedValue(struct TOCValueHdr *theValueHdr);
  /*
...
CM_EXPORT Boolean cmTouchMovedValue(struct TOCValueHdr *theFromValueHdr,
...
CM_EXPORT Boolean cmTouchDeletedValue(struct TOCValueHdr *theValueHdr, struct TOCObject *theObject);
  /*
...
CM_EXPORT void cmImplicitDeleteValueTouch(struct TOCValueHdr *theValueHdr, struct TOCObject *theObject);
  /*
...
CM_EXPORT Boolean cmTouchDeletedProperty(struct TOCProperty *theProperty,
...
CM_EXPORT void cmTouchDeletedObject(struct TOCObject *theObject);
  /*
...
CM_EXPORT Boolean cmGenerateUpdates(struct Container *container);
  /*
...
CM_EXPORT Boolean cmApplyUpdates(struct Container *container);
  /*
