...
struct TOCObject {                    /* Layout of a TOC object:                        */
  ...
  unsigned short   objectFlags;       /*    info flags about the object                 */
  ...
  CMCount		   fileOffset;			/* JeffB: Added to support virtual objects */
  CMSize			allEntrySize;		/* JeffB: Added to support virtual objects */
};
...
#define ObjectIsNotLoaded	0x0020U		/* JeffB: Added to Support Virtual Objects */
...
CM_EXPORT void *cmCreateTOC(unsigned int  tableSize, const struct Container *container);
  /*
...
CM_EXPORT void *cmUseTOC(void *toc, struct Container *container);
  /*
...
CM_EXPORT TOCObjectPtr cmCreateObject(const void *toc, const CMObjectID objectID,
...
CM_EXPORT void cmUncreateObject(const void *toc, const CMObjectID id, CMRefCon refCon,
...
CM_EXPORT void cmDelete1Object(const void *toc, const CMObjectID id, CMRefCon refCon,
...
CM_EXPORT TOCObjectPtr cmFindObject(const void *toc, const CMObjectID id);
  /*
...
CM_EXPORT int cmForEachObject(const void *toc, CMObjectID startingID, CMObjectID endingID,
...
CM_EXPORT void cmDestroyTOC(void **toc, CMRefCon refCon,
                            void (*deleteAction)(TOCObjectPtr object, CMRefCon refCon));
  /*
...
CM_EXPORT TOCObjectPtr cmLinkObject(const void *toc, TOCObjectPtr theObject,
...
CM_EXPORT TOCObjectPtr cmUnlinkObject(const void *toc, TOCObjectPtr theObject);
  /*
...
CM_EXPORT TOCObjectPtr cmGetMasterListHead(const void *toc, unsigned short objectKindFlag);
  /*
...
CM_EXPORT void cmChangeRefNumHandling(const void *toc, Boolean setting);
  /*
...
CM_EXPORT Boolean cmKeepDeletedRefNums(const void *toc);
  /*
