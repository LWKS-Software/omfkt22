...
CM_EXPORT void *cmCreateGlobalNameTbl(ContainerPtr container);
  /*
...
CM_EXPORT void *cmUseGlobalNameTbl(void *table, ContainerPtr container);
  /*
...
CM_EXPORT char *cmIsGlobalNameObject(TOCObjectPtr typePropertyObject, unsigned int  objectID);
  /*
...
CM_EXPORT char *cmGetGlobalTypeName(ContainerPtr container, unsigned int  typeID);
  /*
...
CM_EXPORT char *cmGetGlobalPropertyName(ContainerPtr container, unsigned int  propertyID);
  /*
...
CM_EXPORT GlobalNamePtr cmCreateGlobalName(const void *table, const unsigned char *globalName,
                                           Boolean *dup);
  /*
...
CM_EXPORT GlobalNamePtr cmEnterGlobalName(const void *table, GlobalNamePtr createdGlobalName,
                                          Boolean *dup);
  /*
...
CM_EXPORT GlobalNamePtr cmLookupGlobalName(const void *table, const unsigned char *globalName);
  /*
...
CM_EXPORT TOCObjectPtr cmDefineGlobalNameObject(const ContainerPtr container, unsigned int  objectID,
...
CM_EXPORT int cmForEachGlobalName(const void *table, CMRefCon refCon,
...
CM_EXPORT Boolean cmWriteAllGlobalNames(const void *table);
  /*
...
CM_EXPORT void cmFreeAllGlobalNames(void **table);
  /*
